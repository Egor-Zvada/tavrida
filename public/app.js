    ...
    messages: [
      {
        ...
        role: "assistant",
        content: "Привет! Я СитиГид, твой помощник по СИТИПОЛИИ. Разрулю правила, помогу быстро подготовить игру и спокойно разберу спорные моменты. Отвечаю текстом и, если включено, голосом. Можем начать с кнопки «Подготовить игру».",
      },
    ],
  },
  support: {
